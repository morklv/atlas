...
def main():
    ...
    pointcloud = commands.add_parser("pointcloud", help="Clean a measured point cloud and export terrain evidence")
    pointcloud.add_argument("input", type=Path, help="Input ASCII PLY, XYZ, CSV, or TXT cloud")
